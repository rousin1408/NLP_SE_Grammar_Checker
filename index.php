    ...
    <section class="main-content" id="content">
      ...
      <center>
        <div class="wrapper">
          <ul>
            <li>
                <span><textarea class="textarea"  id=""  placeholder="Enter your English text here...."></textarea></span>
            </li>
            <li>
          ...
          <br>
          <a href="" name="submit"class="btn2">Check</a>
...
$html_output=str_replace("{SENTENCE", $input,$html_template);
echo $html_output;
...
>>>>>>> c91234f64408595f04b426dba18d9b58b388998d:index.html
